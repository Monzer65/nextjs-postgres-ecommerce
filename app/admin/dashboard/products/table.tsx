...
import { RotateCw, PackageOpen, Pencil } from "lucide-react";
...
export default async function ProductsTable({
  ...
  return (
    <div className="rounded-lg border shadow-sm mt-2 min-w-full overflow-x-auto">
            ...
            >
              ...
              <TableCell className="text-center">
                <div className="flex items-center justify-center gap-2">
                  <Link
                    href={`/admin/dashboard/products/edit/${product.id.toString()}`}
                  >
